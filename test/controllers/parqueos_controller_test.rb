...
class ParqueosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parqueo" do
    assert_difference('Parqueo.count') do
      post parqueos_url, params: { parqueo: { estado: @parqueo.estado, ide: @parqueo.ide, tipo: @parqueo.tipo } }
    end
  ...
  test "should update parqueo" do
    patch parqueo_url(@parqueo), params: { parqueo: { estado: @parqueo.estado, ide: @parqueo.ide, tipo: @parqueo.tipo } }
